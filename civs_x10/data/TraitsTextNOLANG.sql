...
WHERE Language = 'LAN'
AND Tag = 'LOC_ABILITY_GARLANSCRIPTION';
...
VALUES ('LAN', 'LOC_POLICY_BLANK_NAME', 'Blank Policy');

INSERT INTO LocalizedText (Language, Tag, Text)
VALUES ('LAN', 'LOC_POLICY_BLANK_DESCRIPTION', 'Policy without effect, so the game does not softlock with germany and greece (by civsx10 mod).');
