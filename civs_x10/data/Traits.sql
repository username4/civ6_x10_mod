...
INSERT INTO Modifiers (ModifierId, ModifierType)
VALUES 
    ('TRAIT_ADJUST_PROGRESS_DIFF_TRADE_BONUS_1' , 'MODIFIER_PLAYER_ADJUST_PROGRESS_DIFF_TRADE_BONUS'),
    ('TRAIT_ADJUST_PROGRESS_DIFF_TRADE_BONUS_2' , 'MODIFIER_PLAYER_ADJUST_PROGRESS_DIFF_TRADE_BONUS'),
    ('TRAIT_ADJUST_PROGRESS_DIFF_TRADE_BONUS_3' , 'MODIFIER_PLAYER_ADJUST_PROGRESS_DIFF_TRADE_BONUS'),
    ('TRAIT_ADJUST_PROGRESS_DIFF_TRADE_BONUS_4' , 'MODIFIER_PLAYER_ADJUST_PROGRESS_DIFF_TRADE_BONUS'),
    ('TRAIT_ADJUST_PROGRESS_DIFF_TRADE_BONUS_5' , 'MODIFIER_PLAYER_ADJUST_PROGRESS_DIFF_TRADE_BONUS'),
    ('TRAIT_ADJUST_PROGRESS_DIFF_TRADE_BONUS_6' , 'MODIFIER_PLAYER_ADJUST_PROGRESS_DIFF_TRADE_BONUS'),
    ('TRAIT_ADJUST_PROGRESS_DIFF_TRADE_BONUS_7' , 'MODIFIER_PLAYER_ADJUST_PROGRESS_DIFF_TRADE_BONUS'),
    ('TRAIT_ADJUST_PROGRESS_DIFF_TRADE_BONUS_8' , 'MODIFIER_PLAYER_ADJUST_PROGRESS_DIFF_TRADE_BONUS'),
    ('TRAIT_ADJUST_PROGRESS_DIFF_TRADE_BONUS_9' , 'MODIFIER_PLAYER_ADJUST_PROGRESS_DIFF_TRADE_BONUS');
